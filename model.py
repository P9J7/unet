...
def unet4(pretrained_weights=None, input_size=(256, 256, 1)):
    ...
    up = Conv2D(1024, 2, activation='relu', padding='same', kernel_initializer='he_normal')(
        UpSampling2D(size=(2, 2))(drop6))
    merge = concatenate([conv5, up], axis=3)
    conv = Conv2D(1024, 3, activation='relu', padding='same', kernel_initializer='he_normal')(merge)
    conv = Conv2D(1024, 3, activation='relu', padding='same', kernel_initializer='he_normal')(conv)
...
def unet4Init(pretrained_weights=None, input_size=(256, 256, 1)):
    inputs = Input(input_size)
    my_init = myInit(1)
    conv1 = Conv2D(64, 3, activation='relu', padding='same', kernel_initializer=my_init)(inputs)
    my_init = myInit(64)
    ...
    conv6 = Conv2D(2048, 3, activation='relu', padding='same', kernel_initializer=my_init)(pool5)
    my_init = myInit(2048)
    conv6 = Conv2D(2048, 3, activation='relu', padding='same', kernel_initializer=my_init)(conv6)
    drop6 = Dropout(0.5)(conv6)

    my_init2 = myInit2(2048)
    up = Conv2D(1024, 2, activation='relu', padding='same', kernel_initializer=my_init2)(
        UpSampling2D(size=(2, 2))(drop6))
    merge = concatenate([conv5, up], axis=3)
    my_init = myInit(1024)
    conv = Conv2D(1024, 3, activation='relu', padding='same', kernel_initializer=my_init)(merge)
    conv = Conv2D(1024, 3, activation='relu', padding='same', kernel_initializer=my_init)(conv)
...
def rawUnet(pretrained_weights=None, input_size=(572, 572, 1)):
    ...
    my_init = myInit(64)
    conv1 = Conv2D(64, 3, activation='relu', padding='valid', kernel_initializer='he_normal')(
        conv1)
    pool1 = MaxPooling2D(pool_size=(2, 2), strides=2)(conv1)
    conv2 = Conv2D(128, 3, activation='relu', padding='valid', kernel_initializer='he_normal')(
        pool1)
    my_init = myInit(128)
    conv2 = Conv2D(128, 3, activation='relu', padding='valid', kernel_initializer='he_normal')(
        conv2)
    pool2 = MaxPooling2D(pool_size=(2, 2), strides=2)(conv2)
    conv3 = Conv2D(256, 3, activation='relu', padding='valid', kernel_initializer='he_normal')(
        pool2)
    my_init = myInit(256)
    conv3 = Conv2D(256, 3, activation='relu', padding='valid', kernel_initializer='he_normal')(
        conv3)
    pool3 = MaxPooling2D(pool_size=(2, 2), strides=2)(conv3)
    conv4 = Conv2D(512, 3, activation='relu', padding='valid', kernel_initializer='he_normal')(
        pool3)
    my_init = myInit(512)
    conv4 = Conv2D(512, 3, activation='relu', padding='valid', kernel_initializer='he_normal')(
        conv4)
    ...
    conv5 = Conv2D(1024, 3, activation='relu', padding='valid', kernel_initializer='he_normal')(
        drop4)
    my_init = myInit(1024)
